...
<td style="width: 125px">
	<th><a href="material-inspection-report.php?id_kedatangan_detail=<?php echo $strql['id_kedatangan_detail'] ?> "target="blank" >Print </a></th>
    
    <th><a href="report-kedatangan.php" >Kembali</a></th>	</table>									
								</td>
