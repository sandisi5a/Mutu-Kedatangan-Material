    ...
    <div class="container body">
      <div class="main_container">
        ...
        <form action="" method="get" align="right" >
                      ...
                      <a href ="print-daftaruser.php" target="blank" class="btn btn-success" ><i class="fa fa-print"></i>Cetak User </a>
...
<br></br>
    ...
    $no = 1;
    if($cari !=''){
      $select = mysqli_query($conn,"SELECT * FROM tb_user where Id_karyawan  like '%".$cari."%' or 
      Nama like '%".$cari."%' or date_of_entry like '%".$cari."%' or email like '%".$cari."%' or departement like '%".$cari."%'"); 
    }else{
     $select = mysqli_query($conn,"SELECT * FROM tb_user where Id_karyawan ");
    }
   if(mysqli_num_rows($select)){
        ...
        <td><?php echo date('d m Y', strtotime($d["date_of_entry"])); ?></td>
        <td><?php echo $d['email']; ?></td>
        <td><?php echo $d['departement']; ?></td>
				<td style="width: 125px">
									<div class="btn-group" role="group">
										<a href="edituser.php?Id_karyawan=<?php echo $d['Id_karyawan'] ?>" class="btn btn-info btn-xs"><i
													class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                          <a href="delete.php?Id_karyawan=<?php echo $d['Id_karyawan'] ?>"
										   onclick="return confirm('Are you sure?')" class="btn btn-danger btn-xs"><i
													class="fa fa-minus-square" aria-hidden="true"></i> Delete</a>
                          <a href="print-user.php?Id_karyawan=<?php echo $d['Id_karyawan'] ?>" target="blank"
