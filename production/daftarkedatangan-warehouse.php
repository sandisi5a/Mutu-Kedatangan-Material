...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    $strql ="SELECT * FROM tb_kedatangan_detail 
            ...
            inner join tb_supllier on tb_kedatangan.code_supplier = tb_supllier.code_supplier order by tgl_masuk desc ";
        ...
        <?php
          $tampil = "SELECT * from tb_kedatangan_detail where id_kedatangan_detail";
          if(!empty($tampil)){
            echo "closed";
          }else{
            echo "completed";
