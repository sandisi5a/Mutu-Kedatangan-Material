    ...
    <div class="container body">
      <div class="main_container">
        ...
        <form action="" method="get" align="right" >
                      ...
                      <a href ="print-daftarsupplier.php" target="blank" class="btn btn-success" ><i class="fa fa-print"></i>Cetak Supplier </a>
...
?>
    ...
    $no = 1;
    if($cari !=''){
      $select = mysqli_query($conn,"SELECT * FROM tb_supllier WHERE code_supplier like '%".$cari."%' or 
      supplier like '%".$cari."%' or alamat like '%".$cari."%' or no_telp like '%".$cari."%'"); 
    }else{
     $select = mysqli_query($conn,"SELECT * FROM tb_supllier WHERE code_supplier order by code_supplier");
    }
   if(mysqli_num_rows($select)){
		while($d = mysqli_fetch_array($select)){
			...
			<tr>
				<td><?php echo $no++; ?></td>
				<td><?php echo $d['code_supplier']; ?></td>
        ...
        <td><?php echo $d['no_telp']; ?></td>
				...
				<td style="width: 125px">
									<div class="btn-group" role="group">
										<a href="editsupplier.php?code_supplier=<?php echo $d['code_supplier'] ?>" class="btn btn-info btn-xs"><i
													class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
										<a href="deletesupplier.php?code_supplier=<?php echo $d['code_supplier'] ?>"
										   onclick="return confirm('Apakah Anda Yakin Ingin Menghapus')" class="btn btn-danger btn-xs"><i
													class="fa fa-minus-square" aria-hidden="true"></i> Delete</a>
                          <a href="print-supplier.php" target="blank"
