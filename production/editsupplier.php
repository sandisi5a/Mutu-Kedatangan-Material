...
$result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tb_supllier WHERE code_supplier='$data'");
    ...
    <div class="container body">
      <div class="main_container">
		...
		<div class="x_panel">
			...
			<div class="x_content">
																<br/>
				<form action="proses-edit-supplier.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" id="name"required class="form-control col-md-7 col-xs-12" name="Supplier" value="<?php echo $data['supplier'] ?>">
							<input type="hidden" id="name"required class="form-control col-md-7 col-xs-12" name="code_Supplier" value="<?php echo $data['code_supplier'] ?>">
            </div>  
					</div>
          <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="alamat">Alamat<span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="textarea" required class="form-control col-md-7 col-xs-12" name="alamat" value="<?php echo $data['alamat'] ?>">
						</div>
					</div>
          <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">No Telp<span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text"  required class="form-control col-md-7 col-xs-12" name="no_telp" value="<?php echo $data['no_telp'] ?>">
						</div>
					</div>
