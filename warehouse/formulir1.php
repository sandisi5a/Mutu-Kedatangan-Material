		...
		<div class="x_panel">
			<div class="x_title">
				...
				<div class="x_content">
					<div class="form-group">
						...
						<input type="text" id="nama_perusahaan"  name="nama_perusahaan" placeholder="Nama Perusahaan" value="<?php echo $data['supplier']; ?>"  required="required" class="form-control col-md-7 col-xs-12">
            </div>
					</div>
				</div>				
			</div>
			<div class="col-md-6 col-xs-12">				
                ...
                <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="" type = "hidden"  id="tgl_masuk" name="tgl_masuk" placeholder="" value=" <?php echo $data['tgl_masuk'];?>" required="" class="form-control col-md-7 col-xs-12">
              </div>
					</div>
  ...
  <div class="card-body">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center">
        ...
        <tbody>
                                <tr>
                                    <td width="20%">
                                        <input type="text"  name="code_item" id="code_item"value="<?php echo $data['code_item']; ?>"class="form-control">
                                   </td>
                                    <td width="20%">
                                    <input type="Text"  id="description_material" name="description_material" value="<?php echo $data['description_material']; ?>" class="form-control">
                                    </td>
                                    <td width="20%">
                                        <input type="text"  name="nomor_sj" id="nomor_sj"  autocomplete="off" value="<?php echo $data['no_sj']; ?>;" required class="form-control">
                                    </td>
                                    <td width="12%">
                                        <input type="text"  name="no_po" id="no_po"  autocomplete="off" value = "<?php echo $data['no_po']; ?>"required class="form-control">
                                    </td>
                                    <td width="15%">
                                        <input type="text"  name="no_lot" id="no_lot"  autocomplete="off" value="<?php echo $data['lot_no']; ?>" required class="form-control">
                                    </td>
                                    <td width="20%">
                                        <input type="text"  name="qty" id="qty"  autocomplete="off" value = "<?php echo $data['qty']; ?>"required class="form-control">
                                    </td>
