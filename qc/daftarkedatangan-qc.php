              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/kansai.jpg" alt="">Quality Control
...
<br></br>
  ...
  include'koneksi.php';
    ...
    if(!empty($_GET['cari_data'])){
      ...
      join tb_kedatangan on tb_kedatangan_detail.id_kedatangan = tb_kedatangan.id_kedatangan
      join tb_supllier on tb_kedatangan.code_supplier = tb_supllier.code_supplier where no_sj like '%".$_GET['cari_data']."%' or 
      no_po like '%".$_GET['cari_data']."%' or tb_kedatangan_detail.code_item like'%".$_GET['cari_data']."%' or tb_material.description_material like'%".$_GET['cari_data']."%'
      or tb_kedatangan.tgl_masuk like'%".$_GET['cari_data']."%' or tb_supllier.supplier like'%".$_GET['cari_data']."%'"); 
    }else{
     $select = mysqli_query($conn,"SELECT * FROM tb_kedatangan_detail 
